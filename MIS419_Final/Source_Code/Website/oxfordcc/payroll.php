...
<h1 align="center">Please select the week you would like a report for</h1>


<form name="aform" method="POST" action="https://www.guinhq.com/oxfordcc/employee/fpdf/payrollpdf.php">
	<table align="center" border="0" style="border-collapse">
		<tr>
			<td align="right">Date:</td>
			<td align="left"><input type="text" id="datepicker" name="week" size="12" placeholder="YYYY-MM-DD"></td>
		</tr>
		<tr>
			<td>
