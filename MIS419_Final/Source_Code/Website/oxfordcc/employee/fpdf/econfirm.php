...
<h1 align="center">Notice: All Paystubs show only the pre-income tax amounts </h1>

<br />
<form name="aform" method="POST" action="AJpdf.php">
	<table align="center" border="0" style="border-collapse">
		...
		<tr>
			<td align="right"><input type='button' value='Cancel' onclick="window.location.href='https://www.guinhq.com/oxfordcc/employee/ehp.php'" /></td>
			<td align="left"><input type="submit" value="Get Paystub History" name="btn"></td>
		</tr>		
	</table>
</form>
