...
Class OxfordNav{
	...
	Public Function Onavbar(){
	session_start();
	If($_SESSION['Access'] == 'owner' || $_SESSION['Access'] == 'accountant'){
		echo "
	...
	Public function Enavbar(){
		...
		echo "
			...
			<nav class='navbar navbar-expand-sm bg-primary navbar-dark'>
			  <a class='navbar-brand' href='https://www.guinhq.com/oxfordcc/mainmenu.php'>
			    <img src='https://www.guinhq.com/oxfordcc/npic.png' width='30' height='30' class='d-inline-block align-top' alt=''>
			    Oxford Construction Company
			  </a>
			  <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarText' aria-controls='navbarText' aria-expanded='false' aria-label='Toggle navigation'>
			    ...
			    <ul class='navbar-nav mr-auto'>
			      ...
			      <li class='nav-item dropdown'>
			       ...
			       <li class='nav-item dropdown'>
			        ...
			        <div class='dropdown-menu' aria-labelledby='navbarDropdown'>
			          <a class='dropdown-item' href='https://www.guinhq.com/oxfordcc/forman/Matdt.php'>Materials Used</a>
			          <a class='dropdown-item' href='https://www.guinhq.com/oxfordcc/forman/addmat.php'>New Material</a>
			        </div>
			      </li>
	...
	Public function Snavbar(){
	
			//session_start();
		If(!$_SESSION['ValidUser']){
			header('Location: https://www.guinhq.com/oxfordcc/login.php');
		} 
		If($_SESSION['Access'] == 'employee' || $_SESSION['Access'] == 'foreman'){
			header('Location: https://www.guinhq.com/oxfordcc/mainmenu.php');
		}
		echo "
			<title>Oxford Construction Co.</title>
			...
			<nav class='navbar navbar-expand-sm bg-primary navbar-dark'>
			  <a class='navbar-brand' href='https://www.guinhq.com/oxfordcc/sec/Sechp.php'>
			    <img src='https://www.guinhq.com/oxfordcc/npic.png' width='30' height='30' class='d-inline-block align-top' alt=''>
			    Oxford Construction Company
			  </a>
			  <button class='navbar-toggler' type='button' data-toggle='collapse' data-target='#navbarText' aria-controls='navbarText' aria-expanded='false' aria-label='Toggle navigation'>
