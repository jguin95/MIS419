...
<h1 align="center">Please Select your Job Report</h1>


<form name="aform" method="POST" action="https://www.guinhq.com/oxfordcc/employee/fpdf/ehrspdf.php">
	<table align="center" border="0" style="border-collapse">
		<tr>
			<td align="right">Inactive Jobs:</td>
			<td align="left">
			  <select name="jobnum">
				  <?php
				  require_once('cru100.php');
					...
					try {
						...
						$STH = $dbc->prepare('SELECT JobName,JobID FROM Jobs WHERE Active=0');
