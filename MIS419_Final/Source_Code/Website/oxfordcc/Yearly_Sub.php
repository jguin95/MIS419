...
<h1 align="center">Please Enter the Report Year</h1>


<form name="aform" method="POST" action="https://www.guinhq.com/oxfordcc/employee/fpdf/Yearly_Report.php">
	<table align="center" border="0" style="border-collapse">
		<tr>
			<td align="right">Report Year:</td>
			<td align="left"><input name="year" size="10" placeholder="YYYY"/></td>
		</tr>
		<tr>
			<td>
