...
<p> </p>
<h1 align="center">Inactive Jobs</h1><a href="jobform.php"><button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add A New Job"><i class="far fa-plus-square fa-lg"></i></button></a><br />
