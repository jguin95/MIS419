...
<p> </p>
<h1 align="center">Active Employee Roster</h1><a href="employeeform.php"><button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add A New Employee"><i class="fas fa-user-plus"></i></button></a><br />
...
<tbody>
	...
	try {
		...
		$STH = $dbc->prepare('SELECT EmpID,EFname,ELname,EDOB,EPhone,Email,HireDate,Active,URMLevel,hrlywage from employees');
